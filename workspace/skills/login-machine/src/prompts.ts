...
### captcha_screen
Use when the page shows a CAPTCHA challenge that must be solved before proceeding.
- Common types: Cloudflare Turnstile, Google reCAPTCHA, hCaptcha
- Also use for full-page challenges like "Just a moment..." / "Verify you are human"
- Set captchaType: "turnstile" | "recaptcha_v2" | "recaptcha_v3" | "hcaptcha" | "cloudflare_challenge" | "unknown"
- Extract siteKey from data-sitekey attribute if visible in HTML
- If the page title is "Just a moment..." or shows "Performing security verification", use captchaType "cloudflare_challenge"

### verification_screen
Use when the page asks the user to enter a verification code sent via SMS, email, or authenticator app.
- The page typically shows: "Enter the code we sent to..." or "Check your phone/email"
- Set verificationMethod: "sms" | "email" | "authenticator" | "unknown"
- Extract the code input field(s) and submit button
- Extract verificationHint if the page shows a masked phone/email (e.g. "***1234" or "h***@gmail.com")
