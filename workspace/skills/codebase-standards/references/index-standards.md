...
The index enables **Inject Standards** step to suggest relevant standards without reading all files. It maps each standard to a brief description for quick matching.
...
2. Ask the user to propose a description:
...
- If **Inject Standards** step suggestions seem out of sync
- To clean up a messy or outdated index

**Note:** **Discover Standards** step runs this automatically as its final step, so you usually don't need to call it separately after discovering standards.
