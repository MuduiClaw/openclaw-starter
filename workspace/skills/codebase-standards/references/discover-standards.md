...
- **Always ask the user directly** when you need input or clarification
...
3. Ask the user to present the areas:
...
3. Ask the user to present findings and let user select:
...
1. **Ask 1-2 clarifying questions** about the "why" behind the pattern. Use your direct conversation for this.
