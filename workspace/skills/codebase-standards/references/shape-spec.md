...
- **Always ask the user directly** when asking the user anything
...
Ask the user to understand the scope:
...
If it exists, read key files (like `mission.md`, `roadmap.md`, `tech-stack.md`) and ask the user:
