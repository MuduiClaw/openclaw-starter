...
If there's only one section, auto-select it. If there are multiple sections, use the direct conversation to ask which section the user wants to generate data for.

Then check if `product/sections/[section-id]/spec.md` exists. If it doesn't:

"I don't see a specification for **[Section Title]** yet. Please run **Shape Section** step first to define the section's requirements, then come back to generate sample data."
...
"I've updated the sample data and types for **[Section Title]** based on your feedback. Review the changes and let me know if you'd like further adjustments, or run **Design Screen** step when you're ready."
...
"Note: A global data shape hasn't been defined yet. I'll create entity structures based on the section spec, but for consistency across sections, consider running **Data Shape** step first."
...
Review the files and let me know if you'd like any adjustments. When you're ready, run **Design Screen** step to create the screen design for this section."
