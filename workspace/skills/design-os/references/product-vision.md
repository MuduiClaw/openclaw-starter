...
After receiving their input, use the direct conversation to ask targeted questions covering all three areas. Ask questions one or two at a time, conversationally, with follow-ups as needed.
...
Review these files and let me know if you'd like to adjust anything. When you're ready, run **Design Tokens** step to choose your color palette and typography, or **Shape Section** step to start designing a section."
