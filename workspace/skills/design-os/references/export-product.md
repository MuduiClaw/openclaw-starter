...
- A product overview (**Product Vision** step)
- A roadmap with sections (**Product Roadmap** step)
...
- [ ] Product entities — Run **Data Shape** step for consistent entity naming
- [ ] Design tokens — Run **Design Tokens** step for consistent styling
- [ ] Application shell — Run **Design Shell** step for navigation structure
