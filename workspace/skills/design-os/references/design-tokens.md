...
"Before defining your design system, you'll need to establish your product vision. Please run the **Product Vision** step first."
...
Ask the user to gather their preferences if they're unsure:
...
Next step: Run **Design Shell** step to design your application's navigation and layout."
