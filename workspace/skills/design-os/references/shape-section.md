...
"I don't see a product roadmap defined yet. Please run **Product Roadmap** step first to define your product sections, then come back to shape individual sections."
...
If there's only one section, auto-select it. If there are multiple sections, use the direct conversation to ask which section the user wants to work on:
...
Use the direct conversation to ask 4-6 targeted questions to define:
...
Feel free to review these files. Let me know if you'd like to adjust anything in the spec or sample data. When you're ready, run **Design Screen** step to create the screen design for this section."
