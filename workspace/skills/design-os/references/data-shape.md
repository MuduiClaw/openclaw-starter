...
"Before defining your data shape, you'll need to establish your product vision. Please run the **Product Vision** step first."
...
This provides a shared vocabulary for your screen designs. When you run **Sample Data** step, it will reference these entities to ensure consistent naming across sections.

Review and let me know if you'd like to adjust anything. When you're ready, run **Design Tokens** step to choose your color palette and typography."
